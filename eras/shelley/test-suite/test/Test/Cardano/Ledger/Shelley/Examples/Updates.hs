...
ppVotes2 :: (PureEraGen (ShelleyEra c), Era (ShelleyEra c)) => ProposedPPUpdates (ShelleyEra c)
ppVotes2 = collectVotes ppVoteA [1, 5]

updateEx3B :: (PureEraGen (ShelleyEra c), Era (ShelleyEra c)) => Update (ShelleyEra c)
...
ppVotes3 :: (PureEraGen (ShelleyEra c), Era (ShelleyEra c)) => ProposedPPUpdates (ShelleyEra c)
